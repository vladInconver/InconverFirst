...
function aletheme_get_options() {
    ...
    $options[] = array( "name" => "Select the body Font from Google Library",
                        "desc" => "The default Font is - Roboto Condensed",
                        "id" => "ale_get_roboto",
    ...
    $options[] = array( "name" => "Select the body Font (Extended) from Google Library",
                        "desc" => "The default Font (extended) is - Roboto Condensed",
                        "id" => "ale_get_robotoex",
                        "std" => "",
                        "type" => "text",
                        );
    ...
    $options[] = array( "name" => "Select the Font (Extended) from Google Library",
                        "desc" => "The default Font (extended) is - Open Sans",
                        "id" => "ale_get_opensansex",
                        "std" => "",
                        "type" => "text",
                        );
    ...
    $options[] = array( 'name' => "H1 Style",
                        ...
                        'id' => 'ale_h1sty',
                        'std' => array('size' => '22px','face' => 'Roboto+Condensed','style' => 'normal','color' => '#ffffff'),
                        'type' => 'typography');
    ...
    $options[] = array( 'name' => "Body Style",
                        ...
                        'id' => 'ale_bodystyle',
                        'std' => array('size' => '14px','face' => 'Open+Sans','style' => 'normal','color' => '#777'),
                        'type' => 'typography');
