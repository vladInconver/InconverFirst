 ...
 */
function inconver_theme_styles() {
	// add general css file
	wp_register_style( 'aletheme_bootstrap_css', THEME_URL . '/css/bootstrap.css', array(), ALETHEME_THEME_VERSION, 'all');
...
function ale_enqueue_scripts() {
    ...
    wp_register_script( 'ale-bootstrap', THEME_URL . '/js/libs/bootstrap.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    ...
    wp_enqueue_script( 'ale-bootstrap' );
