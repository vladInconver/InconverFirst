<?php
$ale_get_roboto = ale_get_option('get_roboto');
$ale_get_opensans = ale_get_option('get_opensans');
...
<?php
    ...
    if(ale_get_option('get_roboto')){ echo "<link href='http://fonts.googleapis.com/css?family=".ale_get_option('get_roboto')."' rel='stylesheet' type='text/css'>"; }
    if(ale_get_option('get_roboto')){ echo "<link href='http://fonts.googleapis.com/css?family=".ale_get_option('get_opensans')."' rel='stylesheet' type='text/css'>"; }
?>
<style type='text/css'>
    body {
        <?php
