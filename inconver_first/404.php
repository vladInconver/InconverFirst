    ...
    <div class="contacts-center">
        <div class="content">
            ...
            <div class="contact-content">
                ...
                <p class="errorh1 qqq"><?php _e('Sorry, but the page you\'re looking for has not found. Try checking the URL for errors, then hit the refresh<br /> button on your browser.','aletheme'); ?></p>
